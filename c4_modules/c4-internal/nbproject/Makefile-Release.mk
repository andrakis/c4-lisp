...
${OBJECTDIR}/lib_src/libinternal.o: lib_src/libinternal.c 
	...
	${RM} "$@.d"
	$(COMPILE.c) -O2 -DCND_PLATFORM=\"${CND_PLATFORM}\" -DCONF_${CND_CONF}=1 -DPROJECTNAME=\"${PROJECTNAME}\" -I../../include -I./include -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/lib_src/libinternal.o lib_src/libinternal.c
