...
extern "C" {
	...
	NUMTYPE syscall5(NUMTYPE, NUMTYPE, NUMTYPE, NUMTYPE, NUMTYPE);
	NUMTYPE syscall6(NUMTYPE, NUMTYPE, NUMTYPE, NUMTYPE, NUMTYPE, NUMTYPE);
	...
	typedef NUMTYPE (syscall5_t)(NUMTYPE,NUMTYPE,NUMTYPE,NUMTYPE,NUMTYPE);
	typedef NUMTYPE (syscall6_t)(NUMTYPE,NUMTYPE,NUMTYPE,NUMTYPE,NUMTYPE,NUMTYPE);
