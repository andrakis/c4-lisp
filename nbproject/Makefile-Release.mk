...
${OBJECTDIR}/core/c4.o: core/c4.c 
	...
	${RM} "$@.d"
	$(COMPILE.c) -O2 -DCND_PLATFORM=\"${CND_PLATFORM}\" -DNDEBUG -DRELEASE -Iinclude -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/core/c4.o core/c4.c

${OBJECTDIR}/core/extras.o: core/extras.c 
	${MKDIR} -p ${OBJECTDIR}/core
	${RM} "$@.d"
	$(COMPILE.c) -O2 -DCND_PLATFORM=\"${CND_PLATFORM}\" -DNDEBUG -DRELEASE -Iinclude -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/core/extras.o core/extras.c

${OBJECTDIR}/core/main.o: core/main.cpp 
	${MKDIR} -p ${OBJECTDIR}/core
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DCND_PLATFORM=\"${CND_PLATFORM}\" -DCPP14 -DNDEBUG -DRELEASE -Iinclude -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/core/main.o core/main.cpp

${OBJECTDIR}/core/syscalls.o: core/syscalls.cpp 
	${MKDIR} -p ${OBJECTDIR}/core
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -DCND_PLATFORM=\"${CND_PLATFORM}\" -DCPP14 -DNDEBUG -DRELEASE -Iinclude -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/core/syscalls.o core/syscalls.cpp
