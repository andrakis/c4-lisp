...
${OBJECTDIR}/_ext/d2a2928e/c4.o: ../core/c4.c 
	...
	${RM} "$@.d"
	$(COMPILE.c) -O2 -DCND_PLATFORM=\"${CND_PLATFORM}\" -DCONF_${CND_CONF}=1 -DPROJECTNAME=\"${PROJECTNAME}\" -I../include -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/d2a2928e/c4.o ../core/c4.c
